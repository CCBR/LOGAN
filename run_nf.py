...
def parse_args():
    ...
    parser.add_argument('--baminput',help='BAM Inputs ')
    parser.add_argument('--baiinput',help="BAI Inputs")
...
def main():
    ...
    c4=["nextflow /data/SCLCgenomics/nousome/WGS_new/wgs-seek/wgs-seek_bam.nf",
