...
\b
CLUSTER EXECUTION:
logan run ... -profile [profile],[profile],...
For information on Nextflow config and profiles see:
https://www.nextflow.io/docs/latest/config.html#config-profiles
\b
RUN EXAMPLES:
Use singularity:    logan run ... -profile singularity
Specify threads:    logan run ... --threads [threads]
Add NextFlow args:  logan run ... -work-dir workDir -with-docker
"""
...
# cli.add_command(citation) # TODO uncomment if logan is published in a journal or Zenodo
